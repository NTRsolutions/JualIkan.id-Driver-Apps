...
public class FragmentOrderFinished extends Fragment {
    ...
    public FragmentOrderFinished() {}

    public static FragmentOrderFinished newInstance() {
        FragmentOrderFinished fragment = new FragmentOrderFinished();
        return fragment;
    }
                                    ...
                                    public void action(View view) {
                                        ...
                                        view.setOnClickListener(new View.OnClickListener() {
                                            ...
                                            public void onClick(View view) {
                                                Intent intent = new Intent(viewFragment.getContext(), DetailDeliveryFinishedActivity.class);
    ...
    private void getDataFromDatabase() {
        ...
        Call call = apiInterface.deliveryFinishedHistory(reIdUser);
